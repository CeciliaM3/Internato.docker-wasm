...
function findWasmBinary() {
    return locateFile('statistics_calc_fetch.wasm');
}
...
var _callback_timeout = Module['_callback_timeout'] = makeInvalidEarlyAccess('_callback_timeout');
...
function assignWasmExports(wasmExports) {
  ...
  Module['_callback_timeout'] = _callback_timeout = createExportWrapper('callback_timeout', 1);
